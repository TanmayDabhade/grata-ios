...
//        let progress = Double(goal.currentDay) / 30.0
...
//                                
//                                Circle()
//                                    .trim(from: 0, to: min(Double(goal.currentDay) / 30.0, 1.0))
//                                    .stroke(accentColor.opacity(0.9), style: StrokeStyle(lineWidth: 8, lineCap: .round))
//                                    .frame(width: 80, height: 80)
//                                    .rotationEffect(.degrees(-90))
//                                    .animation(.spring(response: 0.6, dampingFraction: 0.7), value: goal.currentDay)
//                                
//                                Text("\(Int((Double(goal.currentDay) / 30.0) * 100))%")
...
//                                        )
//                                    )
//                                    .frame(width: geometry.size.width * min(Double(goal.currentDay) / 30.0, 1.0), height: 12)
//                                    .animation(.spring(response: 0.6, dampingFraction: 0.7), value: goal.currentDay)
//                            }
//                        }
//                        .frame(height: 12)
